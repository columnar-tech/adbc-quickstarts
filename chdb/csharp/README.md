...
1. Customize the C# program `Program.cs` as needed
   - Change the SQL SELECT statement assigned to `stmt.SqlQuery`, or keep it set to `SELECT * FROM 'games.parquet';` to query the Parquet file included with this example
