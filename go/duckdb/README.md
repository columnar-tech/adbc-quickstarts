...
# Connecting Go to DuckDB-compatible systems with ADBC

This directory contains examples showing how to use ADBC to connect Go applications to DuckDB-compatible systems.
