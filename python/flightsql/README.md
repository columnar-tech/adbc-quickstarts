...
# Connecting Python and Flight SQL with ADBC

This directory contains examples showing how to use ADBC to connect Python applications to systems that support [Arrow Flight SQL](https://arrow.apache.org/docs/format/FlightSql.html).
