...
# Connecting Kotlin and StarRocks with ADBC
...
1.  Configure StarRocks for Arrow Flight SQL using one of the following options:
    ...
    1.  Edit the FE (frontend) configuration:
        ```sh
    ...
    1.  Edit the BE (backend) configuration:
        ```sh
    ...
    1.  Exit the container and restart it:
        ```sh
        exit
        docker restart quickstart
        ```

1.  Verify the container is ready. Wait for the container to become healthy:
