...
# Connecting Kotlin to MySQL-compatible systems with ADBC

This directory contains examples showing how to use ADBC to connect Kotlin applications to MySQL-compatible database systems.
