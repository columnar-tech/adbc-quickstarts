...
# Connecting Ruby to MySQL-compatible systems with ADBC

This directory contains examples showing how to use ADBC to connect Ruby applications to MySQL-compatible database systems.
