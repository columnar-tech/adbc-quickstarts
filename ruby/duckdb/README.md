...
# Connecting Ruby to DuckDB-compatible systems with ADBC

This directory contains examples showing how to use ADBC to connect Ruby applications to DuckDB-compatible systems.
