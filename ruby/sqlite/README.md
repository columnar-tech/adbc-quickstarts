...
# Connecting Ruby and SQLite with ADBC
...
1. Customize the Ruby script `main.rb` as needed
   - Change the connection options in `database.set_option()`
   ...
   - If you changed the database file, also change the SQL SELECT statement in `connection.query()`
