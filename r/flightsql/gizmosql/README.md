...
1. Run the R script:
   ...
   # A tibble: 5 × 3
     r_regionkey r_name      r_comment                                             
           <int> <chr>       <chr>                                                 
   1           0 AFRICA      "ar packages. regular excuses among the ironic reques…
   2           1 AMERICA     "s are. furiously even pinto bea"                     
   3           2 ASIA        "c, special dependencies around "                     
   4           3 EUROPE      "e dolphins are furiously about the carefully "       
   5           4 MIDDLE EAST " foxes boost furiously along the carefully dogged ti…
   ```
