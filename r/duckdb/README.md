...
# Connecting R to DuckDB-compatible systems with ADBC

This directory contains examples showing how to use ADBC to connect R applications to DuckDB-compatible systems.
